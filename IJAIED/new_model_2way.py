...
def train(model, training_data, validation_data, test_data_ans, optimizer, device, opt, scheduler):
    ...
    for epoch_i in range(opt.epoch):
        ...
        if valid_accu >= max(valid_accus):
                ...
                test_accu_ans, test_loss_ans, accuracy_a,precision_a,recall_a,f1_a, auc_a = test_epoch(model,test_data_ans,device)
                # print('[Info]: For answer task, Test accuracy {}, precision {}, recall {}, f1 {}, auc {}'.format(accuracy_a,precision_a,recall_a, f1_a, auc_a))
                ...
                # print('[Info]: For domain task New Test accuracy {}'.format(test_accu_que))
...
def main():
    ...
    parser.add_argument('-log',type=str, default='./logs/complete_2way_ans')
    parser.add_argument('-save_model',type=str, default='./saved_model/complete_2way_ans')
    ...
    for i in range(1, 2):
        ...
        accuracy_a,precision_a,recall_a,f1_a, auc_a = train(model, train_dataloader, validation_dataloader, test_dataloader_ans,optimizer, opt.device, opt,scheduler)
